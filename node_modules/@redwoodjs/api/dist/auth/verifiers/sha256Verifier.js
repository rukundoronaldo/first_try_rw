...
exports.default = exports.verifySignature = void 0;
...
const verifySignature = ({
  ...
  try {
    ...
    const hmac = (0, _crypto.createHmac)(algorithm, secret);
    payload = typeof payload === 'string' ? payload : toNormalizedJsonString(payload);
    const digest = Buffer.from(algorithm + '=' + hmac.update(payload).digest('hex'), 'utf8'); // constant time comparison to prevent timing attacks
