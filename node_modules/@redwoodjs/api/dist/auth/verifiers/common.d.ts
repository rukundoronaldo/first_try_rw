...
export declare type SupportedVerifiers = SkipVerifier | SecretKeyVerifier | Sha1Verifier | Sha256Verifier | Sha1Verifier | TimestampSchemeVerifier | JwtVerifier;
export declare type SupportedVerifierTypes = keyof typeof verifierLookup;
